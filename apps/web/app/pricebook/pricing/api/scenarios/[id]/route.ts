...
// GET /pricebook/pricing/api/scenarios/[id]
...
// PUT /pricebook/pricing/api/scenarios/[id]
...
// PATCH /pricebook/pricing/api/scenarios/[id] - Update scenario (alias for PUT)
export async function PATCH(request: Request, { params }: RouteParams) {
  return PUT(request, { params });
}

// DELETE /pricebook/pricing/api/scenarios/[id]
