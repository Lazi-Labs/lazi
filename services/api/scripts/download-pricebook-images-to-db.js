...
async function main() {
  ...
  const tables = [
    { name: 'st_pricebook_services', type: 'services' },
    { name: 'st_pricebook_materials', type: 'materials' },
    { name: 'st_pricebook_equipment', type: 'equipment' },
    { name: 'st_pricebook_categories', type: 'categories' },
  ];
