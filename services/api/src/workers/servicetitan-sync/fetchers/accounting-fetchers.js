...
export class PaymentsFetcher extends BaseFetcher {
  ...
  transformRecord(record) {
    return {
      ...
      applied_to: record.appliedTo || null,
      auth_code: record.authCode || null,
      batch: record.batch || null,
      business_unit: record.businessUnit || null,
      check_number: record.checkNumber || null,
      created_by: record.createdBy || null,
      customer: record.customer || null,
      custom_fields: record.customFields || null,
      payment_date: record.date,
      deposit: record.deposit || null,
      gl_account: record.generalLedgerAccount || null,
      memo: record.memo || null,
      reference_number: record.referenceNumber || null,
      total: record.total || 0,
      payment_type: typeof record.type === 'object' ? record.type?.name : record.type,
