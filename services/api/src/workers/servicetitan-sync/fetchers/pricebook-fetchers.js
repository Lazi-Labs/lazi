...
export class PricebookMaterialsFetcher extends BaseFetcher {
  ...
  transformRecord(record) {
    return {
      ...
      unit_of_measure: record.unitOfMeasure || null,
      is_inventory: record.isInventory ?? false,
      // JSONB columns - ensure not undefined
      account: record.account || null,
      cost_of_sale_account: record.costOfSaleAccount || null,
      asset_account: record.assetAccount || null,
      primary_vendor: record.primaryVendor || null,
      other_vendors: record.otherVendors || null,
...
export class PricebookServicesFetcher extends BaseFetcher {
  ...
  transformRecord(record) {
    return {
      ...
      categories: record.categories || null,
      assets: record.assets || null,
      service_materials: record.serviceMaterials || null,
      service_equipment: record.serviceEquipment || null,
      recommendations: record.recommendations || null,
      upgrades: record.upgrades || null,
      st_created_on: record.createdOn,
      st_modified_on: record.modifiedOn,
      fetched_at: new Date(),
      full_data: record,
